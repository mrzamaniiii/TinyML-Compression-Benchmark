...
#include "depthwise_model.h"
#include "raw_scaler.h"

#include <math.h>


// ============================================================
// REAL-TIME DEPTHWISE CNN GESTURE CLASSIFIER
// ------------------------------------------------------------
// Target:
// Arduino Nano 33 BLE
//
...
//
// IMPORTANT:
// depthwise_model.h must contain:
//
...
// Class names
//
// We currently keep generic class names because the exact
// training label order must match the dataset/model.
// Replace these strings later with the actual gesture names.
// ============================================================
...
void initializeTensorFlow()
{
    ...
    {
        fatalStop(
            "depthwise_model is not 16-byte aligned"
        );
    }
