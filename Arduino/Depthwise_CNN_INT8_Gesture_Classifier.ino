...
#include "depthwise_cnn_model.h"
#include "depthwise_cnn_scaler.h"
...
// 128 × 6 samples
//  ↓
// Standardization using depthwise_cnn_scaler.h
//  ↓
// INT8 quantization
//  ↓
// Depthwise CNN
...
//
// IMPORTANT:
// depthwise_cnn_model.h must contain:
//
...
void initializeTensorFlow()
{
    ...
    {
        fatalStop(
            "depthwise_cnn_model is not 16-byte aligned"
        );
    }
